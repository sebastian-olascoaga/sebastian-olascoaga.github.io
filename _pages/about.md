...
While that was fun, I decided to start my Ph.D. at [MIT](https://www.mit.edu/). The main objective of my research is to understand big societal problems that affect vulnerable populations across the globe by using big data and empirical methods, such as machine learning and natural experiments. I then focus on proposing and evaluating policies to mitigate or eliminate those problems. Geographically, I focus on two neighborhood countries: Mexico and the USA. Conceptually, I specialize in two topics: socioeconomic mobility and inequality in Mexico and geographic health inequalities and its macroeconomic determinants in the US.g.
